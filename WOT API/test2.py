    ...
    if isinstance(clan_id_data, list) and clan_id_data:
        for clan_id in clan_id_data:
            ...
            if clan_members_data:
                ...
                save_to_json(clan_members_data, f"clan_{clan_id}_members.json")
                print(f"Informacje o członkach klanu o id {clan_id} zapisane do pliku 'clan_{clan_id}_members.json'.")
            else:
